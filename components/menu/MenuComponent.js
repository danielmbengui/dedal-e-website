...
import {LINK_ABOUT_PAGE, LINK_ACCOUNT_PAGE, LINK_BUY_PAGE, LINK_DEDALAB_PAGE, LINK_GALLERY_PAGE, LINK_HOME_PAGE, LINK_VR_PAGE} from "@/constants/pages";
...
<_Builtin.HtmlEmbed
    ...
    <Button startContent={<_Builtin.HtmlEmbed
                  className={`html-embed-3 ${LINK_ACCOUNT_PAGE === router.asPath ? 'active' : ''}`}
