      ...
      <_Builtin.Block className="main-wrapper" tag="div">
        <_Builtin.Block className="section-header" tag="div">
          ...
          <_Builtin.Block className="header-content" tag="div">
            ...
            >
              <_Builtin.Link
                className="fn-button customize-bot"
                button={true}
                block=""
            ...
            <PaddingSmall />
            <_Builtin.Link
              className="link-block-6 next"
              data-w-id="ba860cde-dc82-e612-f3a3-30185fef07f4"
              button={false}
              block="inline"
              options={{
...
function AlertDialogSlide({openDialog, setOpenDialog}) {
  //const myDialogOpen = isOpen;
...
function CustomizedDialogs({openDialog, setOpenDialog}) {
    ...
    <React.Fragment>
      ...
      */
      ...
      <BootstrapDialog
        ...
        open={openDialog}
      >
        <DialogTitle sx={{ m: 0, p: 2, color:'var(--black)' }} id="customized-dialog-title">
          Modal title
        </DialogTitle>
        <IconButton
          aria-label="close"
        ...
        >
          <CloseIcon sx={{color:'var(--black)'}} />
        </IconButton>
        <DialogContent dividers>
          <Typography gutterBottom sx={{color:'var(--black)'}}>
