  ...
  return (
    <_Component className={_utils.cx(_styles, "page-wrapper")} tag="div">
      ...
      <_Builtin.Block className={_utils.cx(_styles, "main-wrapper")} tag="div">
        <_Builtin.Block
          className={_utils.cx(_styles, "section-header", "home")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "header-content-left")}
            tag="div"
          >
            <_Builtin.Image
              className={_utils.cx(_styles, "header-line")}
              loading="lazy"
              width="auto"
              height="auto"
              alt=""
            ...
            />
            <_Builtin.Block
              className={_utils.cx(_styles, "header-social-icon-wrapper")}
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "header-content")}
            tag="div"
          >
            <_Builtin.Heading
            ...
            <PaddingSmall />
            <_Builtin.Block
              className={_utils.cx(_styles, "header-button-row")}
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "header-scroll-down-arrow", "home")}
          ...
          >
            ...
            >
              <_Builtin.Image
                className={_utils.cx(_styles, "image-logo-header-home")}
                loading="lazy"
                width="70"
                height="auto"
                alt=""
        ...
        <_Builtin.Section
          className={_utils.cx(_styles, "section-partners")}
          grid={{
            type: "section",
          }}
          tag="div"
        >
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "fn-section")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "fn-container-grid-3")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "fn-column-2")}
                  id={_utils.cx(
                    _styles,
                    "w-node-_2e7715b2-4b3d-d4e5-9b86-6af5dc4f0ba0-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Heading
                  ...
                  <_Builtin.Paragraph
                    className={_utils.cx(_styles, "fn-paragraph-2")}
                  >
                    {
                  ...
                  <_Builtin.Link
                    className={_utils.cx(_styles, "fn-button-secondery-2")}
                    id={_utils.cx(
                      _styles,
                      "w-node-_2e7715b2-4b3d-d4e5-9b86-6af5dc4f0ba5-71812e24"
                    )}
                    button={true}
                    block=""
                    options={{
                ...
                <_Builtin.Block
                  className={_utils.cx(_styles, "fn-logos-grid")}
                  id={_utils.cx(
                    _styles,
                    "w-node-_2e7715b2-4b3d-d4e5-9b86-6af5dc4f0ba7-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "fn-logos-card")}
                    tag="div"
                  >
                    <_Builtin.HtmlEmbed
                      className={_utils.cx(_styles, "fn-logos-masonary-logo")}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "uui-section_logos03")}
          tag="section"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "uui-page-padding-3")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "uui-container-large-3")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "uui-logos03_component")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "uui-logos03_logo-list")}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "uui-logos03_wrapper")}
                    id={_utils.cx(
                      _styles,
                      "w-node-_5e4a5e74-f7d1-b130-1ba8-d76cacbb0af6-71812e24"
                    )}
                    tag="div"
                  >
                    <_Builtin.Image
                      className={_utils.cx(_styles, "uui-logos03_logo")}
                      loading="lazy"
                      width="auto"
                      height="Auto"
                      alt="Company logo"
                  ...
                  <_Builtin.Block
                    ...
                    id={_utils.cx(
                      _styles,
                      "w-node-_5e4a5e74-f7d1-b130-1ba8-d76cacbb0afe-71812e24"
                    )}
                    tag="div"
                  />
                </_Builtin.Block>
        ...
        >
          ...
          >
            <_Builtin.HtmlEmbed
              className={_utils.cx(_styles, "uui-logos-loop-css-embed")}
            ...
            <_Builtin.Block tag="div">
              <_Builtin.Block
                className={_utils.cx(_styles, "uui-logos04_list")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "uui-logos04_wrapper")}
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec32874-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                    className={_utils.cx(_styles, "uui-logos04_logo")}
                    loading="lazy"
                    width="auto"
                    height="auto"
                    alt="Company logo"
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec32876-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec32878-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec3287a-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec3287c-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec3287e-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec32880-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
              ...
              >
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec3288f-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec32891-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec32893-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec32895-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec32897-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec32899-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
                ...
                <_Builtin.Block
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-a0175ace-1ece-22c5-2291-a14f5ec3289b-71812e24"
                  )}
                  tag="div"
                >
                  <_Builtin.Image
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "section-newsletter")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "padding-global")}
          ...
          >
            ...
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "padding-section-newsletter")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "newsletter-component")}
                  data-w-id="5777dbc1-9dc9-325f-a56d-710af1f7595c"
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "newsletter-left-content")}
                    tag="div"
                  >
                    <_Builtin.Block
                      className={_utils.cx(_styles, "newsletter-icon-wrapper")}
                      tag="div"
                    >
                      <_Builtin.Image
                        className={_utils.cx(_styles, "newsletter-icon")}
                        loading="lazy"
                        width="40"
                        height="40"
                        alt=""
                  ...
                  <_Builtin.Block
                    className={_utils.cx(_styles, "newsletter-right-content")}
                    tag="div"
                  >
                    <_Builtin.FormWrapper
                      className={_utils.cx(_styles, "newsletter-from-block")}
                    >
                      <_Builtin.FormForm
                        className={_utils.cx(_styles, "newsletter-from")}
                        name="email-form"
                      ...
                      >
                        <_Builtin.FormTextInput
                          className={_utils.cx(_styles, "newsletter-input")}
                          autoFocus={false}
                          maxLength={256}
                          name="Email-4"
                          data-name="Email 4"
