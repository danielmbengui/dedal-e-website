...
export function Navbar({ as: _Component = _Builtin.NavbarWrapper }) {
  ...
  return (
    ...
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "padding-global", "menu")}
        tag="div"
      >
        <_Builtin.Block
        ...
        >
          <_Builtin.Block className={_utils.cx(_styles, "div-block")} tag="div">
            <_Builtin.Block
              className={_utils.cx(_styles, "navigation-left")}
              tag="div"
            >
              <_Builtin.NavbarBrand
                className={_utils.cx(_styles, "nav-logo-wrapper")}
                id="id-nav-logo"
                options={{
                  href: "#",
                }}
          ...
          >
            ...
            >
              <_Builtin.List
                className={_utils.cx(_styles, "nav-link-list")}
                tag="ul"
                unstyled={false}
              >
                <_Builtin.ListItem
                  className={_utils.cx(_styles, "nav-link-list-item")}
                >
                  <_Builtin.NavbarLink
              ...
              <_Builtin.Link
                className={_utils.cx(_styles, "fn-button", "show-menu")}
                button={true}
                block=""
                options={{
                  href: "#",
            ...
            >
              <_Builtin.Link
                className={_utils.cx(_styles, "quick-phone-call", "cart")}
                button={false}
                block="inline"
                options={{
                  href: "#",
              ...
              >
                <_Builtin.DropdownToggle
                  className={_utils.cx(_styles, "dropdown-lang-toogle")}
                  tag="div"
                >
                  <_Builtin.HtmlEmbed
                ...
                <_Builtin.DropdownList
                  className={_utils.cx(_styles, "dropdown-lang-list")}
                  tag="nav"
                >
                  <_Builtin.Link
                    className={_utils.cx(_styles, "link-block-lang", "first")}
                    button={false}
                    block="inline"
                    options={{
                      href: "#",
                  ...
                  >
                    <_Builtin.Block
                      className={_utils.cx(_styles, "div-flag")}
                      tag="div"
                    >
                      <_Builtin.Image
                    ...
                    <_Builtin.Block
                      className={_utils.cx(_styles, "div-text-flag")}
                      tag="div"
                    >
                      <_Builtin.Block
                  ...
                  <_Builtin.Link
                    className={_utils.cx(_styles, "link-block-lang")}
                    button={false}
                    block="inline"
                    options={{
                      href: "#",
                  ...
                  <_Builtin.Link
                    className={_utils.cx(_styles, "link-block-lang", "last")}
                    button={false}
                    block="inline"
                    options={{
                      href: "#",
                ...
                >
                  ...
                  >
                    <_Builtin.Link
                      ...
                      id={_utils.cx(
                        _styles,
                        "w-node-_087b38d3-bb16-de61-e483-c97c79ade6b5-e0eeec7b"
                      )}
                      button={false}
                      block="inline"
                      options={{
                    ...
                    <_Builtin.Link
                      ...
                      id={_utils.cx(
                        _styles,
                        "w-node-_087b38d3-bb16-de61-e483-c97c79ade6bd-e0eeec7b"
                      )}
                      button={false}
                      block="inline"
                      options={{
                    ...
                    <_Builtin.Link
                      ...
                      id={_utils.cx(
                        _styles,
                        "w-node-abbb1c25-98c6-6dfa-be8e-cf21e6cd62cf-e0eeec7b"
                      )}
                      button={false}
                      block="inline"
                      options={{
                    ...
                    <_Builtin.Link
                      ...
                      id={_utils.cx(
                        _styles,
                        "w-node-d427e37c-a5fb-6be1-8ef3-12a8b5b15043-e0eeec7b"
                      )}
                      button={false}
                      block="inline"
                      options={{
                    ...
                    <_Builtin.Link
                      ...
                      id={_utils.cx(
                        _styles,
                        "w-node-e1800e03-b07b-8f18-d481-dd264916953f-e0eeec7b"
                      )}
                      button={false}
                      block="inline"
                      options={{
                    ...
                    <_Builtin.Link
                      ...
                      id={_utils.cx(
                        _styles,
                        "w-node-a3b7329e-e12a-e313-0227-4cdc0d51c21b-e0eeec7b"
                      )}
                      button={false}
                      block="inline"
                      options={{
                    ...
                    <_Builtin.Link
                      ...
                      id={_utils.cx(
                        _styles,
                        "w-node-_339b36f4-92e2-d6dc-0daa-a0b2e3c5ca3a-e0eeec7b"
                      )}
                      button={false}
                      block="inline"
                      options={{
                    ...
                    <_Builtin.Link
                      ...
                      id={_utils.cx(
                        _styles,
                        "w-node-f8376cda-4124-f347-4d3d-b4d43a31446c-e0eeec7b"
                      )}
                      button={false}
                      block="inline"
                      options={{
                    ...
                    <_Builtin.Link
                      ...
                      id={_utils.cx(
                        _styles,
                        "w-node-b70deb88-6ddd-a13e-c74f-740f716618a5-e0eeec7b"
                      )}
                      button={false}
                      block="inline"
                      options={{
                    ...
                    <_Builtin.Link
                      ...
                      id={_utils.cx(
                        _styles,
                        "w-node-_065c7fe8-b6d3-d452-20a4-8de6509bc3a3-e0eeec7b"
                      )}
                      button={false}
                      block="inline"
                      options={{
              ...
              <_Builtin.Link
                className={_utils.cx(_styles, "link-login")}
                button={false}
                block="inline"
                options={{
                  href: "#",
            ...
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "menu-line-wrapper")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "menu-line", "top")}
                  tag="div"
                />
                <_Builtin.Block
                  className={_utils.cx(_styles, "menu-line", "middle")}
                  tag="div"
                />
                <_Builtin.Block
                  className={_utils.cx(_styles, "menu-line", "last")}
                  tag="div"
                />
              </_Builtin.Block>
            </_Builtin.NavbarButton>
